...
<div class="max-w-xl">
    <div class="mb-6">
        ...
        <h1 class="text-2xl font-bold text-slate-800">Dodaj nową salę</h1>
    </div>

    <div class="bg-white rounded-2xl border border-slate-200 shadow-sm p-6">
        <form method="POST" action="<?= url('admin/rooms/store') ?>" class="space-y-5">
            <div>
                ...
                <input type="text" id="name" name="name"
                       ...
                       required placeholder="np. Sala A101"
            ...
            <div class="grid grid-cols-2 gap-4">
                <div>
                    ...
                    <input type="text" id="building" name="building"
                           ...
                           required placeholder="np. Budynek A"
                           class="w-full border border-slate-300 rounded-xl px-3.5 py-2.5 text-sm
                                  focus:outline-none focus:ring-2 focus:ring-indigo-400 transition">
                </div>
                <div>
                    ...
                    <input type="number" id="floor" name="floor"
                           value="<?= htmlspecialchars($_POST['floor'] ?? '0') ?>"
                           min="-1" max="30"
                           class="w-full border border-slate-300 rounded-xl px-3.5 py-2.5 text-sm
                                  focus:outline-none focus:ring-2 focus:ring-indigo-400 transition">
                </div>
            ...
            <div>
                ...
                <input type="number" id="capacity" name="capacity"
                       value="<?= htmlspecialchars($_POST['capacity'] ?? '10') ?>"
            ...
            <div>
                ...
                <textarea id="description" name="description" rows="3"
                          placeholder="np. Sala komputerowa z rzutnikiem…"
                          class="w-full border border-slate-300 rounded-xl px-3.5 py-2.5 text-sm
                                 focus:outline-none focus:ring-2 focus:ring-indigo-400 transition"><?= htmlspecialchars($_POST['description'] ?? '') ?></textarea>
            </div>
